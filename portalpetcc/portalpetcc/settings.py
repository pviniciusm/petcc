...
TEMPLATE_DIRS = (
    ...
    os.path.join(PROJECT_ROOT_PATH, 'atividades/templates'),
    os.path.join(PROJECT_ROOT_PATH, 'oportunidades/templates'),
    os.path.join(PROJECT_ROOT_PATH, 'projetos/templates'),
)


WSGI_APPLICATION = 'portalpetcc.wsgi.application'
...
SUIT_CONFIG = {
    'ADMIN_NAME': 'Administração do Portal PET-CC'
}
